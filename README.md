...
| Single UPDATE | 단일 UPDATE 원자 연산 | 2,085ms | 8,709ms | 500 RPS에서 6% 드롭 |
...
| Redis Counter | Lua (INCR 원자 연산) | **9.2ms** | 1,074ms | 2,000 RPS에서 5% 드롭 |
...
|------|------|-----------------|-----------------|------|
| Kafka | Lua + Kafka produce | **8.1ms** | **15ms** | 5,000 RPS에서 1.5% 드롭 |
| Redis Streams | Lua (INCR + XADD 원자) | **2.3ms** | **12ms** | 5,000 RPS에서 1.2% 드롭 |
